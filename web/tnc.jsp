<%-- 
    Document   : tnc
    Created on : Aug 19, 2015, 10:40:04 AM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <title>Lorium | Terms and Conditions</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <div id="container">
            <jsp:include page="header.jsp" />
                ...
                <div id="highlight">
                    ...
                    <p>
                        Last updated: August 19, 2015<br/>

                        Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the http://www.lorium.com website (the "Service") operated by Lorium ("us", "we", or "our").<br/>
                        ...
                        Our Service may contain links to third-party web sites or services that are not owned or controlled by Lorium.<br/>

                        Lorium has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that Lorium shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.<br/>
                        ...
                        These Terms shall be governed and construed in accordance with the laws of South Africa, without regard to its conflict of law provisions.<br/>
                        ...
                        Our Terms and Conditions agreement was created by TermsFeed.<br/>
